...
import controllers.{ComposeEmailController, ComposeEmailForm, ControllerSetupBase, RemoveUploadedFileFormProvider}
...
import views.html.{ComposeEmail, EmailDeleteConfirmation, EmailPreview, EmailSentConfirmation, ErrorTemplate, ForbiddenView, RemoveEmailView}
